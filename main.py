...
e_mail_text = f"""
Just checking if the e-mail functionality
Is working
...
https://asciiart.website/index.php?art=television/the%20office
"""


# Entrypoint
if __name__ == "__main__":
    logger_obj.info("Succesfully implemented logging")
    e_mail_obj.send_email(subject="Testing Email Functionality",
                          body= e_mail_text)
